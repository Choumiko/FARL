...
FARL = {
  ...
  get_rails_below_train = function(self, no_limit)
    local behind = self:rail_behind_train()
  ...
  bulldozerModeAllowed = function(self)
  ...
  calcTrainDir = function(self, ent)
